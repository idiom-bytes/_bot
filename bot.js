...
bot.onText(/\/burn/, async (msg) => {
  ...
  // const xampText = `Current price of XAMP is: *$${xampUsd}*. Target Price is *TODO*. *${lastXampRebaseDate}* the last burn. *TODO* till the next burn`;

  // const tobText = `Current price of TOB is: $${tobUsd}`;
